...
WORKFLOWS = (
    WorkflowSpec(
        ...
        (sys.executable, "scripts/review_online_payments.py"),
        "Collections",
        "Review required",
        "http://127.0.0.1:8765",
    ),
    ...
    WorkflowSpec(
        ...
        (
            sys.executable,
            "scripts/check_duplicate_customer_payments.py",
            "--output",
    ...
    WorkflowSpec(
        ...
        (sys.executable, "scripts/export_icici_unmatched_csv.py"),
        "Banking",
    ),
    WorkflowSpec(
        5,
        "Payment allocation repair plan",
        "Preview invoice allocations for legacy review-queue payments.",
        (sys.executable, "scripts/repair_review_payment_allocations.py"),
        "Collections",
    ),
    WorkflowSpec(
        6,
        "Matched-payment link backfill preview",
        "Preview links between Creator records and existing Books payments.",
        (sys.executable, "scripts/backfill_creator_matched_payments.py"),
        "Collections",
    ),
)
